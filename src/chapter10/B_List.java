...
// - 빠른 조회 기능에 적합, 삽입과 삭제 시 데이터 이동이 필요하여 상대적으로 성능이 저하
...
public class B_List {
	public static void main(String[] args) {
		...
		System.out.println(startTime); // 49686028471625
		
		for(int i = 0; i < 222222; i++) {
			arrayListTest.add(0, i); // 항상 맨 앞에 요소 삽
		}
		...
		for(int i = 0; i < 222222; i++) {
			linkedListTest.add(0, i); // 항상 맨 앞에 요소 삽
		}
