...
public class B_Enum {
	public static void main(String[] args) {
		...
		System.out.println(Fruits.values()); // [Lchapter16.Fruits;@33e5ccce
		...
		System.out.println(size + "'s ml: " + size.getMl()); // MEDIUM's ml: 300
		
		CoffeeSize anotherSize = CoffeeSize.LARGE;
		System.out.println(anotherSize + "'s ml: " + anotherSize.getMl()); // LARGE's ml: 400
