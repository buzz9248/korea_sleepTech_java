...
public class A_Wrapper {
	public static void main(String[] args) {
		...
		new Integer("50"); // 문자열을 받아 해당하는 int 값을 받는 Integer 객체 생성
//		new Integer("안녕");
		...
		// a.compareTo(Integer anotherInt): 두 Integer 객체를 비교해서 같으면 0, 호출 객체(a)가 더 크면 양수, 더 작으면 음수 반환
