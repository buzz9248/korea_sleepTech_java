...
public class E_Practice {
	public static void main(String[] args) {
		...
		// 인스턴스 생성
		BaseballPlayer player1 = new BaseballPlayer("윤영서", 0.369, 16);
		BaseballPlayer player2 = new BaseballPlayer("문창배", 0.888, 20);
		BaseballPlayer player3 = new BaseballPlayer("전창현", 0.257, 11);
		BaseballPlayer player4 = new BaseballPlayer("고혁재", 0.234, 21);
