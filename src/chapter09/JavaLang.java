...
public class JavaLang {
	public static void main(String[] args) {
		...
		MyClass myClass1 = new MyClass(1, "문창배");
		System.out.println(myClass1);
		// MyClass(ID: 1 / NAME: 문창배)
		// : 객체를 출력하는 경우 자동으로 toString() 호출 - 생략 가능
		System.out.println(myClass1.toString());
		
		System.out.println(myClass1.displayInfo()); // ID: 1 / NAME: 문창배
		
		MyClass myClss2 = new MyClass(2, "문창배2");
		System.out.println(myClass1.equals(myClss2)); // false
		...
		// 문자열의 equals() 메서드는 두 문자열의 내용(값)을 비교한다.
